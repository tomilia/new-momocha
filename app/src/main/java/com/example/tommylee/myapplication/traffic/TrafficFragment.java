package com.example.tommylee.myapplication.traffic;
...
public class TrafficFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_traffic,container,false);
        drawerLayout=getActivity().findViewById(R.id.container);

        TextView toolbartext=view.findViewById(R.id.various_text);
        toolbartext.setText("交通一覽");
