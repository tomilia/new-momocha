...
import com.example.tommylee.myapplication.expandrecyclerview.Genre;
...
public class GenreViewHolder extends GroupViewHolder {
    ...
    public GenreViewHolder(View itemView) {
        ...
        icon = (View) itemView.findViewById(R.id.list_item_genre_icon);
    ...
    private void animateExpand() {
        ...
        arrow.setImageResource(R.drawable.sortup);
    ...
    private void animateCollapse() {
        ...
        rotate.setFillAfter(true);
        arrow.setAnimation(rotate);
        arrow.setImageResource(R.drawable.caretdown);
        icon.setVisibility(View.GONE);
    }
}