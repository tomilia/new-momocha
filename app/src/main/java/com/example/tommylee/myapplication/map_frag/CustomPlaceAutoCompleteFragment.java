 ...
 */
public class CustomPlaceAutoCompleteFragment extends RecyclerView.Adapter<CustomPlaceAutoCompleteFragment.PlaceViewHolder> implements Filterable{
    ...
    public CustomPlaceAutoCompleteFragment(Context context, int resource, GoogleApiClient googleApiClient,
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            Log.d("mapsearch",mBounds.toString());
            // This method should have been called off the main UI thread. Block and wait for at most 60s
            // for a result from the API.
            AutocompletePredictionBuffer autocompletePredictions = results
                    .await(50, TimeUnit.SECONDS);
